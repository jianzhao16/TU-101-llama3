...
def ask_openai_for_service_extraction(question, api_key, conversation_history):
    ...
    response = generator.text_completion(prompts=[full_conversation], max_gen_len=64, temperature=0.6, top_p=0.9)
...
def classify_service_type(service_type, api_key):
    ...
    "{service_type}": """
    response = generator.text_completion(prompts=[prompt], max_gen_len=60, temperature=0.6, top_p=0.9)
